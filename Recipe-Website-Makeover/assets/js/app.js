class RecipeApp {
    ...
    init() {
        this.bindEvents();
        this.renderRecipes();
        this.renderFavorites(); // make sure favorites render on load
    ...
    bindRecipeActions() {
        document.querySelectorAll('.favorite-btn').forEach(btn => {
            btn.addEventListener('click', (e) => {
                ...
                this.renderFavorites(); // update favorites list immediately
            });
        });
    ...
    showRecipeModal(recipeId) {
        ...
        content.innerHTML = `
            <img src="${recipe.image || 'https://via.placeholder.com/150'}" alt="${recipe.name}" class="modal-recipe-image">
        ...
        favoriteBtn.addEventListener('click', () => {
            ...
            this.renderFavorites(); // update favorites list
